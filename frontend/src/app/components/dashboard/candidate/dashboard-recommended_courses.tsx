...
const DashboardRecommendedCourses = ({ setIsOpenSidebar }: IProps) => {
  ...
  useEffect(() => {
    const getCandidateDetailsUsingEmail = async () => {
      try {
        const response = await axios.get(`http://a80ab3f4d07d1472e9703892bfd831e4-2032056606.us-east-1.elb.amazonaws.com:5000/api/auth/getCandidateDetailsUsingEmail/${localStorage.getItem("email")}`);
