...
async function loginCompanyHR(req, res) {
    try {
        ...
        // console.log(token);
        res.status(200).json({ message: 'Company_HR logged in successfully',id: CompanyHR.companyHR_id ,firstname: CompanyHR.firstname, lastname: CompanyHR.lastname, role: "companyHR" });
    } catch (error) {
        console.log(error);
